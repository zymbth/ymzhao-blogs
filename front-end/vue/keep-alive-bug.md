...
head:
  - - meta
    - name: keywords
      content: KeepAlive,缓存失效,include,name,推导
created: '2024-09-27'
badge: 'BUG'
---
...
::: tip
在 3.2.34 或以上的版本中，使用 setup 语法糖的单文件组件会自动根据文件名生成对应的 [name](https://cn.vuejs.org/api/options-misc.html#name) 选项，无需再手动声明。
:::
...
个人推荐使用第二种方法，且组件名称与路由名称保持一致，这样有利于进行**动态**缓存管理
